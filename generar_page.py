content = """import { getResumenNacional } from "./lib/api";
...
with open("C:/educacion-argentina-data/frontend/app/page.tsx", "w", encoding="utf-8") as f:
    f.write(content)

print("page.tsx generado OK")
